...
def debug_create_pokemon(
    ...
    data_to_encrypt = (
        ...
        + pack_uint8(moves[0].move.pp if len(moves) > 0 else 0)
        + pack_uint8(moves[1].move.pp if len(moves) > 1 else 0)
        + pack_uint8(moves[2].move.pp if len(moves) > 2 else 0)
        + pack_uint8(moves[3].move.pp if len(moves) > 3 else 0)
        + pack_uint8(evs.hp)
